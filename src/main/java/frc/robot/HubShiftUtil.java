...
public class HubShiftUtil {
  ...
  private static final double maxTimeOfFlight = 2.5;
  ...
  private static Supplier<Optional<Alliance>> allianceWinOverride = () -> Optional.empty();

  public static void setAllianceWinOverride(Supplier<Optional<Alliance>> override) {
    allianceWinOverride = override;
  }

  public static Optional<Alliance> getAllianceWinOverride() {
